...
df = pd.read_csv("/data/train_preprocessed_flow.csv")
...
df.to_csv("/data/train_preprocessed_flow_afterdropped.csv", index=True)
...
def main():
    ...
    wandb.agent(sweep_id, lambda: train_function("PyTorch", make_config_file("/data/train_preprocessed_flow_afterdropped.csv", 4500, 6000)))
